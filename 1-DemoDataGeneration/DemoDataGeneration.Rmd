...
This document contains the data generation process for the dataset `DemoData` included in the `LRMoE` package. This also serves as an example of using the `SimYSet` function included in the package.
